...
class InformaticaActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.informatica) // Vincula el archivo XML

        val webView: WebView = findViewById(R.id.webview_pdf_informatica)
        val progressBar: ProgressBar = findViewById(R.id.progressBar_informatica)
