...
class TelecomunicacionesActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.telecomunicaciones) // Vincula el archivo XML

        val webView: WebView = findViewById(R.id.webview_pdf_telecomunicaciones)
        val progressBar: ProgressBar = findViewById(R.id.progressBar_telecomunicaciones)
