...
class DGIIADEActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.dgiiade) // Vincula el archivo XML

        val webView: WebView = findViewById(R.id.webview_pdf_dgiiade)
        val progressBar: ProgressBar = findViewById(R.id.progressBar_dgiiade)
