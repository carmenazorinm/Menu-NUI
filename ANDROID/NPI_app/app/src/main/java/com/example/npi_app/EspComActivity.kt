...
class EspComActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.espacios_comunes) // Vincula el archivo XML

        val webView: WebView = findViewById(R.id.webview_pdf_esp_com)
        val progressBar: ProgressBar = findViewById(R.id.progressBar_esp_com)
        ...
        try {
            ...
            webView.loadUrl("https://etsiit.ugr.es/sites/centros/etsiit/public/inline-files/ETSIIT_Salas.pdf")
